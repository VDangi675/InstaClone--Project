...
mongoose.connect(process.env.DATABASE_URL || "mongodb+srv://VIKAS:VIKAS12@cluster0.ekplytw.mongodb.net/?retryWrites=true&w=majority").then(() => {
...
app.get("/", (req, res) => {
    res.send("InstaClone Backend By Vikas")
})
